...
class RouteSmokeTest(unittest.TestCase):
    ...
    def test_roadmap_page_renders_project_ideas(self):
        ...
        self.assertIn(b'Guided connectivity diagnostics module', response.data)
        ...
        self.assertIn(b'Connectivity diagnostics trophies', response.data)
        ...
        self.assertIn(b'Tabbed connectivity diagnostics workspace', response.data)
        self.assertIn(b'Ping and reachability testing', response.data)
        self.assertIn(b'Device-page reachability actions', response.data)
        self.assertIn(b'Reachability history and comparisons', response.data)
        ...
        self.assertIn(b'Train Controller integration', response.data)
        self.assertIn(b'Train Controller repository compatibility review', response.data)
        self.assertIn(b'Train Controller feature inventory and import plan', response.data)
        self.assertIn(b'Train Controller integration boundary', response.data)
        self.assertIn(b'Train Controller workflow and progress bridge', response.data)
        self.assertIn(b'https://github.com/sudo-rpaisley/Train-Controller', response.data)
        self.assertIn(b'View source repository', response.data)
