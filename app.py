...
ROADMAP_SECTIONS = [
    ...
    },
    {
        ...
        'items': [
            ...
            {'title': 'Vehicle diagnostic function database', 'priority': 'High', 'priority_class': 'danger', 'status': 'Done', 'completed_note': 'CSV/TSV capability matrices are staged for review, split multi-function cells, retain model/year/system/variant/subfunction details, and support offline filtering.', 'description': 'Import and search scan-tool functions by vehicle model, year range, control system, engine/variant, function, and subfunction.'},
